...
local function CreateGUI(title)
    ...
    disagreeButton.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
    ...
    agreeButton.BackgroundColor3 = Color3.fromRGB(255, 176, 0)
    agreeButton.Text = "同意"
